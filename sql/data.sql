USE [sanitarycart]
GO
/****** Object:  Table [dbo].[GstRate]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Category]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Brand]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Series.Brand]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Product]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Image]    Script Date: 10/23/2020 21:19:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Default [DF_Brand_IsActive]    Script Date: 10/23/2020 21:19:50 ******/
ALTER TABLE [dbo].[Brand] ADD  CONSTRAINT [DF_Brand_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO
/****** Object:  Check [Price_Greater_Than_Zero]    Script Date: 10/23/2020 21:19:50 ******/
...
GO
/****** Object:  Check [Quantity_Greater_Than_Zero]    Script Date: 10/23/2020 21:19:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Category_Category]    Script Date: 10/23/2020 21:19:50 ******/
ALTER TABLE [dbo].[Category]  WITH CHECK ADD  CONSTRAINT [FK_Category_Category] FOREIGN KEY([ParentId])
REFERENCES [dbo].[Category] ([Id])
GO
ALTER TABLE [dbo].[Category] CHECK CONSTRAINT [FK_Category_Category]
GO
/****** Object:  ForeignKey [FK_Image_Product]    Script Date: 10/23/2020 21:19:50 ******/
...
GO
/****** Object:  ForeignKey [FK_Product_Category]    Script Date: 10/23/2020 21:19:50 ******/
ALTER TABLE [dbo].[Product]  WITH CHECK ADD  CONSTRAINT [FK_Product_Category] FOREIGN KEY([CategoryId])
REFERENCES [dbo].[Category] ([Id])
GO
ALTER TABLE [dbo].[Product] CHECK CONSTRAINT [FK_Product_Category]
GO
/****** Object:  ForeignKey [FK_Product_GstRate]    Script Date: 10/23/2020 21:19:50 ******/
